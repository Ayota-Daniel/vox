...
import { ArticleCardVertical } from "../cards/card-article-verticale"
...
const articles = articlesJSON.slice(40,70);

const PAGE_SIZE = 6

const FormationsPageComponent = () => {
...
export default FormationsPageComponent